     ...
     ?>
      ...
      <?php
		...
		if ($multisite)
		{
          ...
          $old_value = $row['option_value'];
          $new_value = str_replace($url_pattern,$url_replace,$old_value);
          $update = "UPDATE `" . $table_prefix . "options` SET option_value='" . $new_value . "' WHERE option_name='fileupload_url'";
          $result2 = mysql_query($update);
          if($result2)
          {
        ...
        while($row = mysql_fetch_assoc($result))
        {
          ...
          $update = "UPDATE `" . $table_prefix . "taxonomymeta` SET meta_value = '" . $new_value . "' WHERE meta_id = '" .  $id ."'";
		...
		$sql = "SELECT meta_key, meta_value FROM `" . $table_prefix . "postmeta` WHERE meta_value LIKE '%" .$url_pattern. "%'";
        $result = mysql_query($sql);
        ...
        while($row = mysql_fetch_assoc($result))
        {
          ...
          $update = "UPDATE `" . $table_prefix . "postmeta` SET meta_value = '" . $new_value . "' WHERE meta_key = '" .  $key ."'";
		...
		if ($multisite)
		{
			...
			$old_value = $row['meta_value'];
			$new_value = str_replace($url_pattern,$url_replace,$old_value);
			$update = "UPDATE `" . $table_prefix . "sitemeta` SET meta_value='" . $new_value . "' WHERE meta_key='siteurl'";
			$result2 = mysql_query($update);
			if($result2)
			{
			...
			foreach ($tables as $tablename)
			{
			  ...
			  $old_value = $row['option_value'];
			  $new_value = str_replace($url_pattern,$url_replace,$old_value);
			  $update = "UPDATE `" . $tablename . "` SET option_value='" . $new_value . "' WHERE option_name='home'";
			  $result2 = mysql_query($update);
			  if($result2)
			  {
			  ...
			  $old_value = $row['option_value'];
			  $new_value = str_replace($url_pattern,$url_replace,$old_value);
			  $update = "UPDATE `" . $tablename . "` SET option_value='" . $new_value . "' WHERE option_name='siteurl'";
			  $result2 = mysql_query($update);
			  if($result2)
			  {
			  ...
			  $old_value = $row['option_value'];
			  $new_value = str_replace($url_pattern,$url_replace,$old_value);
			  $update = "UPDATE `" . $tablename . "` SET option_value='" . $new_value . "' WHERE option_name='fileupload_url'";
			  $result2 = mysql_query($update);
			  if($result2)
			  {
